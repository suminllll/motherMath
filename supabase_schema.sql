...
CREATE INDEX IF NOT EXISTS idx_lectures_grade ON lectures USING GIN (grade);
...
INSERT INTO lectures (title, description, youtube_url, grade) VALUES
('중1 정수와 유리수 기초', '정수와 유리수의 개념과 사칙연산을 배워봅시다.', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', ARRAY['middle-1']),
('중2 일차함수의 그래프', '일차함수의 그래프를 그리고 해석하는 방법을 알아봅시다.', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', ARRAY['middle-2']),
('고1 이차함수의 최댓값과 최솟값', '이차함수에서 최댓값과 최솟값을 구하는 다양한 방법을 학습합니다.', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', ARRAY['high-1']);